                                                    ...
                                                    <div class="card-block">
                                                        <h4 class="sub-title">Cad. Usuário</h4>
                                                           ...
                                                           <button type="button" class="btn btn-primary waves-effect waves-light" onclick="limparform();">Novo</button>
												            ...
												            <button type="button" class="btn btn-info waves-effect waves-light" onclick="ajaxDeletar();">Excluir</button>
    ...
    <div class="modal-content">
      ...
      <!-- body -->
        ...
        <div class="input-group mb-3">
          ...
          <button class="btn btn-info" type="button" id="button-addon2" onclick="buscarUsuario();">Buscar</button>
        </div>
...
function ajaxDeletar() {
    ...
    if (confirm('Deseja realmente excluir os dados?')){
	 ...
	 $.ajax({
	     ...
	     method: "get",
	     url : urlAction,
	     data : "id=" + idUser + '&acao=ajaxDeletar',
	     success: function (response) {
